...
$_SESSION['msg']="veterinary Specialization updated successfully !!";
...
<html lang="en">
	<head>
		<title>Admin | Edit veterinary Specialization</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Edit veterinary Specialization</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
									...
									<li class="active">
										<span>Edit veterinary Specialization</span>
									</li>
								</ol>
							</div>
						</section>
